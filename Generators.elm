...
magaTweets = NE.Nonempty "You tell em Mr President sir!!"
             [ "fuck me daddy"
             , "build the wall mr president"
             ]

resistTweets = NE.Nonempty "LOL COVFEFE YOU IDIOT DUMMY MORON, GO BACK TO RUSSIA"
               [ "you are a total dumbfuck"
               , "fuck me harder daddy"
               ]

boringTweets = NE.Nonempty "i dont know why im here"
               [ "you are not my daddy" ]

npcTextGenerator : Alignment -> Generator String
npcTextGenerator alignment =
  case alignment of
    User.Maga -> sample magaTweets
    User.Resist -> sample resistTweets
    User.Boring -> sample boringTweets
